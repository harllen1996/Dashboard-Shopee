...
const translations = {
  pt: {
    ...
    'app.tab.produtividade': 'Produtividade',
    ...
    'app.loadDemo': 'Carregar Dados de Demonstração',
    
    'prod.rankingTitle': 'Top 10 Operadores',
    'prod.bottomRankingTitle': 'Estações com Menor Produtividade',
    'prod.topStationRankingTitle': 'Top Estações por Produtividade',
    'prod.tierListTitle': 'Tier List por Processo',
    'prod.performanceDist': 'Distribuição de Performance',
    'prod.highPerformance': 'Operadores Alta Performance',
    'prod.avgProductivity': 'Média de Produtividade',
    'prod.totalBips': 'Total de BIPs',
    'prod.activeOperators': 'Operadores Ativos',
    'prod.gold': 'OURO',
    'prod.silver': 'PRATA',
    'prod.bronze': 'BRONZE',
    'prod.alertBanner': '⚠️ Atenção: Alto volume de operadores abaixo da média de produtividade.',
    'prod.insightsTitle': 'Insights Operacionais Automáticos',
    'prod.noData': 'Faça o upload de um arquivo de produtividade para visualizar os dados.',
    'prod.operator': 'Operador',
    'prod.bips': 'BIPs',
    'prod.level': 'Nível',
    ...
    'rel.onlyOver3Days': 'Apenas pedidos com +3 dias na estação',
    'rel.momTitle': 'Comparativo Mensal de Volume e Aging',
    'rel.momVolume': 'Volume de Pedidos',
    'rel.momAging': 'Média de Aging (Dias)',
    'rel.sec1_over3': 'Este relatório foca exclusivamente em pedidos com mais de 3 dias de retenção na estação.',
  ...
  en: {
    ...
    'app.tab.produtividade': 'Productivity',
    ...
    'app.loadDemo': 'Load Demo Data',
    
    'prod.rankingTitle': 'Top 10 Operators',
    'prod.bottomRankingTitle': 'Stations with Lowest Productivity',
    'prod.topStationRankingTitle': 'Top Stations by Productivity',
    'prod.tierListTitle': 'Tier List by Process',
    'prod.performanceDist': 'Performance Distribution',
    'prod.highPerformance': 'High Performance Operators',
    'prod.avgProductivity': 'Average Productivity',
    'prod.totalBips': 'Total BIPs',
    'prod.activeOperators': 'Active Operators',
    'prod.gold': 'GOLD',
    'prod.silver': 'SILVER',
    'prod.bronze': 'BRONZE',
    'prod.alertBanner': '⚠️ Warning: High volume of operators below productivity average.',
    'prod.insightsTitle': 'Automated Operational Insights',
    'prod.noData': 'Upload a productivity file to view the data.',
    ...
    'rel.onlyOver3Days': 'Only orders with +3 days in station',
    'rel.momTitle': 'Monthly Volume and Aging Comparison',
    'rel.momVolume': 'Order Volume',
    'rel.momAging': 'Average Aging (Days)',
    'rel.sec1_over3': 'This report focuses exclusively on orders with more than 3 days of retention in the station.',
